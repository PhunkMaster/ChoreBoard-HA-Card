            ...
            ${s.map(t=>W`
                <div class="chore-item ${this.getChoreStateClass(t)}">
                  ...
                  <div class="chore-action">
                    ${"completed"!==t.status?W`
                          <mwc-button @click=${()=>this.completeChore(t)}>
                            Complete
                          </mwc-button>
                        `:W`<div class="completed-badge">✓ Done</div>`}
                  </div>
                </div>
              `)}
          </div>
